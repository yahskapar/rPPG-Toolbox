...
from neural_methods.model.RTrPPG3DED import N3DED128, N3DED64, N3DED32, N3DED16, N3DED8
from neural_methods.trainer.BaseTrainer import BaseTrainer
from torch.autograd import Variable
from tqdm import tqdm


class RTrPPG3DEDTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        # self.model = N3DED8(
        #     frames=config.MODEL.RTrPPG3DED.FRAME_NUM).to(self.device)  # [3, T, 128,128]
